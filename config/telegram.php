    ...
    'bots' => [
        'aduancepat_bot' => [
            ...
            'commands' => [
                ...
                App\Telegram\Commands\AduanCommand::class,      // Tambahkan ini
                App\Telegram\Commands\StatuskuCommand::class,     // Tambahkan ini  
                App\Telegram\Commands\BantuanCommand::class,
            ],
        ],
